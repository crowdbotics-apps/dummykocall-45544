"""
Django settings for dummykocall_45544 project.
...
ROOT_URLCONF = 'dummykocall_45544.urls'
...
WSGI_APPLICATION = 'dummykocall_45544.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dummykocall_45544 API",
    "DESCRIPTION": "API documentation for dummykocall_45544 App",
    "VERSION": "v1",
}
